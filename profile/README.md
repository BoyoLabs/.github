...
<br />
$> I also do a lot of work with openscad. Basically, the philosophy is <br />that I try to make things for myself ultimately. Even if it already <br />exists, having my own allows me to have more control and pride in what I am doing. Of course, there are some things I just don't want to do, like run my own github server.
<br />
